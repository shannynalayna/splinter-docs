...
![]({% link
docs/0.5/examples/gameroom/walkthrough/images/act3_diagram.png %}
"Winning Bubba Bakery board"){:height="100%" width="100%"}
...
<table class ="gameroom_db_table" border="1">
  ...
  <tr class="gameroom_db_data">
    ...
    <td><code>56ec82cb...480cad32</code></td>
    <td><code>0384781f...5a7e4998</code></td>
    <td><code>{\"iv\":...cgXrm\"}</code></td>
  </tr>
</table>
...
![]({% link
docs/0.5/examples/gameroom/walkthrough/images/b2_diagram.png %}
"Two-Phase Commit")
...
`PROPOSAL_RESULT`. The following TwoPhaseMessage protobuf defines these message
types.
